...
# file-on-disk path resolution. Content is honest — Upskill Coach is a
...
<html><head>
<meta charset="utf-8">
<title>{title} — Upskill Coach</title>
...
<h2>Contact</h2>
<p>For privacy questions, contact the owner via the email associated
with the account.</p>
"""
...
<h2>Disclaimer</h2>
<p>Upskill Coach is provided as-is for personal educational use. The
