...
<section class="hiw-row flip">
  <div class="hiw-copy">
    ...
    <p class="hiw-note">Message frequency varies — the rhythm follows
    your replies and what you've agreed on together.</p>
  </div>
  <div class="hiw-visual">
    <div class="mock">
...
<p>Yes. Theo is delivered entirely by text message, so signing up
means opting in to texts — there is nothing to deliver without it.
You can withdraw consent at any time by replying STOP.</p>

<h3>How many messages will I get?</h3>
<p>Message frequency varies — it follows your replies and what
you've agreed on with Theo. No messages are sent outside what you've
opted into.</p>
...
<p>Message frequency varies with the user's replies and what they
have agreed on with Theo. Users may pause or stop messaging at any
time by replying <strong>STOP</strong>.</p>
...
<h2>Message frequency</h2>
<p>Message frequency varies based on your replies and what you have
agreed on with Theo. You can pause or stop messaging at any time by
replying STOP.</p>

<h2>Opt-in</h2>
<p>Consent to receive text messages is collected through our
<a href="/sms-signup">web signup form</a>, via a single
never-pre-checked checkbox covering Theo's conversational program
(replies, agreed check-ins, and requested follow-ups). Because Theo
is delivered by text message, this consent is required to sign up;
providing your phone number alone does not constitute consent, and
consent may be withdrawn at any time by replying STOP.</p>
...
<p>Leave your details to sign up. Theo talks with you over text
message, so the consent box below is part of signing up.</p>
...
<form method="POST" action="/sms-signup" style="margin-top:20px">
  ...
  <div style="margin-top:18px; display:flex; gap:10px; align-items:flex-start;">
    ...
    asked for. Message frequency varies. Message and data rates may
    apply. Reply HELP for help or STOP to cancel at any time.</label>
  </div>

  <p style="margin-top:16px">Theo is delivered by text message, so
  this consent is required to sign up. You can withdraw it anytime by
  replying STOP.</p>
...
async def _sms_signup_submit_handler(request):
    ...
    # reader of either sees the truth. Consent is REQUIRED since
    # 2026-08-21 — Theo is delivered by text; a signup without it
    ...
    if not consent_checkins:
        return _signup_error(
            "Theo is delivered by text message, so the consent "
            "checkbox is required to sign up.")
