...
An AI coach that sits as a **layer on top of whatever the user is using to upskill** (a bootcamp, YouTube tutorials, DataCamp, their own toy project). It does not provide curriculum. Its job:
...
- Content generation / animations / curriculum
